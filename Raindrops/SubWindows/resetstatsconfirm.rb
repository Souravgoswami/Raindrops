...
# Image.new path: 'images/bg1.png', width: $width, height: $height

warning_text = Text.new font: 'fonts/arima.otf', text: 'Warning! Are you Sure to Reset Your Data?', x: 30, y: 20, color: 'white', size: 15
